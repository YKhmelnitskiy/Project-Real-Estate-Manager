L.ParallaxMarker = L.Marker.extend({
  ...
  _onZoomStart: function(e) {
    ...
    map.once("zoomend", function() {
      console.log("@ zoomend", tempLatLng, origLatLng); this.options.parallaxZoffset = origParallaxZoffset; this.setLatLng(origLatLng); this._onMapMove();
    }, this);
  },
...
L.parallaxMarker = function(latlng, opts) {
  return new L.ParallaxMarker(latlng, opts);
};
