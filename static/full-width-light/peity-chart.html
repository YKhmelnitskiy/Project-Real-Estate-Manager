						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<p class="text-muted">Add code in span <code> class="pie"</code> plus for colors <code>data-peity='{ "fill": ["#8BC34A", "#AED581"]}'.</code></p>
									<div class="row mt-40">
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>1/5</span>
											<div>Data : 1/5</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>226/360</span>
											<div>Data : 226/360</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>0.52/1.561</span>
											<div>Data : 0.52/1.561</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>1,4</span>
											<div>Data : 1,4</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>226,134</span>
											<div>Data : 226,134</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="pie" data-peity='{ "fill": ["#8BC34A", "#AED581"]}'>0.52,1.041</span>
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="row mt-40">
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"]}'>1/5</span>
											<div>Data : 1/5</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"]}'>226/360</span>
											<div>Data : 226/360</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"], "innerRadius": 16, "radius": 32 }'>0.52/1.561</span>
											<div>Data : 0.52/1.561</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"], "innerRadius": 20, "radius": 32 }'>1,4</span>
											<div>Data : 1,4</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"], "innerRadius": 23, "radius": 32 }'>226,134</span>
											<div>Data : 226,134</div>
										</div>
										<div class="col-sm-2 col-xs-6">
											<span class="donut" data-peity='{ "fill": ["#AED581", "#8BC34A"], "innerRadius": 8, "radius": 32 }'>0.52,1.041</span>
											<div>Data : 0.52, 1.041</div>
										</div>
									</div>
								</div>
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="row mt-40">
										<div class="col-sm-4 col-xs-6"><span class="peity-bar" data-peity='{ "fill": ["#AED581", "#8BC34A"]}' data-width="100%" data-height="60">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span></div>
										<div class="col-sm-4 col-xs-6"><span class="peity-bar" data-peity='{ "fill": ["#AED581", "#8BC34A"]}' data-width="100%" data-height="60">6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span></div>
										<div class="col-sm-4 col-xs-6"><span class="peity-bar" data-peity='{ "fill": ["#AED581", "#8BC34A"]}' data-width="100%" data-height="60">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span></div>
									</div>
								</div>
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									...
									<div class="row mt-40">
										<div class="col-sm-4 col-xs-6"><span class="peity-line" data-peity='{ "fill": ["#AED581"],"stroke":["#AED581"]}' data-width="100%" data-height="60">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span></div>
										<div class="col-sm-4 col-xs-6"><span class="peity-line" data-peity='{ "fill": ["#AED581"],"stroke":["#AED581"]}' data-width="100%" data-height="60">6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span></div>
										<div class="col-sm-4 col-xs-6"><span class="peity-line" data-peity='{ "fill": ["#AED581"], "stroke":["#AED581"]}' data-width="100%" data-height="60">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span></div>
									</div>
								</div>
